function update_vigipool_modal_auxiliary_2_prog_1(set_sched_value_save = "") {
    ...
    // Schedule 1
    // At
    $("#vigipool_modal_auxiliary_2_prog_1_sched_1_begin").html(converter("dec", "time_2", parseInt(begin)));
    $("#myvigipool_modal_auxiliary_2_prog_1_sched_1_begin").val(begin);
    // During
    $("#vigipool_modal_auxiliary_2_prog_1_sched_1_end").html(converter("dec", "time_2", parseInt(end)));
    $("#myvigipool_modal_auxiliary_2_prog_1_sched_1_end").val(end);

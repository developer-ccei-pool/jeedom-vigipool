...
<div class="transition vigipool_ui_text_modal">
    ...
    <div class="vigipool_modal_auxiliary_prog_1_sched_2">
        <h4><?php get_text("schedule"); ?> 2</h4>
        <h4><?php get_text("from"); ?></h4>
        <?php create_slider("vigipool_modal_auxiliary_prog_1_sched_2_begin", 0, 24 * 4); ?>
        <h4><?php get_text("to"); ?></h4>
    ...
    <div class="vigipool_modal_auxiliary_prog_1_sched_3">
        ...
        <h4><?php get_text("from"); ?></h4>
        <?php create_slider("vigipool_modal_auxiliary_prog_1_sched_3_begin", 0, 24 * 4); ?>
        <h4><?php get_text("to"); ?></h4>
...
<script>
    ...
    $(".vigipool_modal_auxiliary_prog_1_button_save").click(function () {
        quick_send("s44_w", "aux_sched", "info", "desired", set_auxiliary_sched_value_save);
    });
    access_modal(".vigipool_modal_auxiliary_prog_1_button_back", "vigipool_modal_auxiliary", 0);
    access_modal(".vigipool_modal_auxiliary_prog_1_button_back", "vigipool_modal_auxiliary", 1);


    // Off On

    $(".vigipool_modal_auxiliary_prog_1_button_off").click(function () {
        ...
        var new_program_1_off_on_and_days = get_sched_value(auxiliary_sched, "program_1_off_on_and_days");
        ...
        var new_auxiliary_sched = set_auxiliary_sched_value("prog_1_off_on_and_days", new_program_1_off_on_and_days);
        update_vigipool_modal_auxiliary_prog_1(new_auxiliary_sched);
    });
    $(".vigipool_modal_auxiliary_prog_1_button_on").click(function () {
        if (set_auxiliary_sched_value_save === "") {
            var auxiliary_sched = get_value_from_position(eq_modal, "aux_sched");
        } else {
            var auxiliary_sched = set_auxiliary_sched_value_save;
    ...
    var id = "vigipool_modal_auxiliary_prog_1_sched_1_begin";
    var init_value = get_sched_value(auxiliary_sched, "program_1_sched_1_begin");
    var division = 1;
    var unit = "";
    var disable = false;
    var type = "u8_w";
    var variable = "vigipool_modal_auxiliary_prog_1_sched_1_begin";
    var info = "info";
    var desired = "desired";
    var value = 1;
    create_slider_sched(id, init_value, division, unit, disable, type, variable, info, desired, value, "time_4");

    var id = "vigipool_modal_auxiliary_prog_1_sched_1_end";
    var init_value = fix_end_dec(get_sched_value(auxiliary_sched, "program_1_sched_1_end"));
    var division = 1;
    var unit = "";
    var disable = false;
    var type = "u8_w";
    var variable = "vigipool_modal_auxiliary_prog_1_sched_1_end";
    var info = "info";
    var desired = "desired";
    var value = 1;
    create_slider_sched(id, init_value, division, unit, disable, type, variable, info, desired, value, "time_4");

    var id = "vigipool_modal_auxiliary_prog_1_sched_2_begin";
    var init_value = get_sched_value(auxiliary_sched, "program_1_sched_2_begin");
    var division = 1;
    var unit = "";
    var disable = false;
    var type = "u8_w";
    var variable = "vigipool_modal_auxiliary_prog_1_sched_2_begin";
    var info = "info";
    var desired = "desired";
    var value = 1;
    create_slider_sched(id, init_value, division, unit, disable, type, variable, info, desired, value, "time_4");

    var id = "vigipool_modal_auxiliary_prog_1_sched_2_end";
    var init_value = fix_end_dec(get_sched_value(auxiliary_sched, "program_1_sched_2_end"));
    var division = 1;
    var unit = "";
    var disable = false;
    var type = "u8_w";
    var variable = "vigipool_modal_auxiliary_prog_1_sched_2_end";
    var info = "info";
    var desired = "desired";
    var value = 1;
    create_slider_sched(id, init_value, division, unit, disable, type, variable, info, desired, value, "time_4");

    var id = "vigipool_modal_auxiliary_prog_1_sched_3_begin";
    var init_value = get_sched_value(auxiliary_sched, "program_1_sched_3_begin");
    var division = 1;
    var unit = "";
    var disable = false;
    var type = "u8_w";
    var variable = "vigipool_modal_auxiliary_prog_1_sched_3_begin";
    var info = "info";
    var desired = "desired";
    var value = 1;
    create_slider_sched(id, init_value, division, unit, disable, type, variable, info, desired, value, "time_4");

    var id = "vigipool_modal_auxiliary_prog_1_sched_3_end";
    var init_value = fix_end_dec(get_sched_value(auxiliary_sched, "program_1_sched_3_end"));
    var division = 1;
    var unit = "";
    var disable = false;
    var type = "u8_w";
    var variable = "vigipool_modal_auxiliary_prog_1_sched_3_end";
    var info = "info";
    var desired = "desired";
    var value = 1;
    create_slider_sched(id, init_value, division, unit, disable, type, variable, info, desired, value, "time_4");
    ...
    //    var init_value = get_sched_value(auxiliary_sched, "program_1_bright");
    //    var division = 1;
    //    var unit = "°C";
    //    var disable = false;
    //    var type = "u16_w";
    ...
    $(".vigipool_modal_auxiliary_prog_1_sched_2_add").click(function () {
        $(".vigipool_modal_auxiliary_prog_1_sched_2_add").hide();
        $(".vigipool_modal_auxiliary_prog_1_sched_2").show();
    });
    $(".vigipool_modal_auxiliary_prog_1_sched_3_add").click(function () {
    ...
    function manage_day(day) {
        $(".vigipool_modal_auxiliary_prog_1_1_" + day).click(function () {
    ...
    $(".vigipool_modal_auxiliary_prog_1_button_thermo_off").click(function () {
        if (set_auxiliary_sched_value_save === "") {
            var auxiliary_sched = get_value_from_position(eq_modal, "aux_sched");
        } else {
            var auxiliary_sched = set_auxiliary_sched_value_save;
        }
        var new_auxiliary_sched = set_auxiliary_sched_value("prog_1_bright", 0);
        update_vigipool_modal_auxiliary_prog_1(new_auxiliary_sched);
    });
    $(".vigipool_modal_auxiliary_prog_1_button_thermo_on").click(function () {
        if (set_auxiliary_sched_value_save === "") {
            var auxiliary_sched = get_value_from_position(eq_modal, "aux_sched");
        } else {
            var auxiliary_sched = set_auxiliary_sched_value_save;
        }
        var new_auxiliary_sched = set_auxiliary_sched_value("prog_1_bright", 1);
        update_vigipool_modal_auxiliary_prog_1(new_auxiliary_sched);
    });
